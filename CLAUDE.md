...
2. Run `python3 -m unittest test_lint.py -v` from `skills/lint/scripts/`. All tests must pass.
3. Manually smoke-test `init`, `ingest`, `query`, `lint` against a scratch wiki.
